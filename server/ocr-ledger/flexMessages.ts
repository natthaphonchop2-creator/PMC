...
function draftDetails(draft: OcrDraft): FlexText[] {
  return [
    ...
    detail('ชื่อร้านค้า', draft.merchantName),
    detail('เลขผู้เสียภาษี', draft.merchantTaxId),
    detail('สาขา', draft.branch),
    detail('วิธีชำระเงิน', draft.paymentMethod),
